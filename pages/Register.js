            ...
            <div className='w-screen h-screen bg-gradient-to-r from-indigo-500/50 via-purple-500/50 to-pink-500/50 flex flex-col items-center justify-center'>
                <div className="bg-gray-100/75 w-11/12 rounded-3xl h-96 flex flex-col items-center sm:w-4/12">
                    <div className="w-24 py-5 px-6 bg-blue-900 rounded-full mt-10">
                        <Image alt="user icon" src="/img/login/graf.png" width="64" height="64px" />
                    </div>
                    <div>
                        <form>
                ...
                <button className="bg-gradient-to-t from-gray-100 text-white w-4/6 py-3 text-2xl font-extrabold rounded-b-2xl sm:w-1/6">REGISTER</button>
            </div>
        </>
